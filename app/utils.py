...
def optimize_class_allocation(df, num_class, max_gender_dev=2, max_dev=1):
    ...
    isolated_at_risk = df['is_isolated_at_risk'].to_numpy()
    ...
    total_isolated_at_risk = np.sum(isolated_at_risk)
